...
const SignupComponent = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        axios.post('http://localhost:3001/saas', { name, email, password })
        ...
        <>
            <div className='w-full min-h-screen flex flex-col md:flex-row justify-center items-center'>
                ...
                <div className='w-full md:w-1/3 lg:w-2/5 min-h-screen p-4 md:p-6 flex flex-col justify-center items-center gap-4 md:gap-6'>
                    ...
                    <span className='mt-4 text-sm md:text-base text-center'>
                        If you're registered, <strong className='cursor-pointer text-blue-500 hover:text-blue-700' onClick={() => (navigate('/login'))}>Login</strong>
                    </span>
                </div>
            </div>
        </>
